...
export function TickerTape({ symbols, colorTheme='dark' }){
  ...
  return <TVWrap title="Ticker Tape" height={46} src="https://s.tradingview.com/external-embedding/embed-widget-ticker-tape.js" config={{
...
export function AdvancedChart({ symbol='NSE:RELIANCE', theme='dark', interval='D', height=420 }){
  ...
  return <TVWrap title={`Advanced Chart ${tvSym}`} height={height} src="https://s.tradingview.com/external-embedding/embed-widget-advanced-chart.js" config={{
...
export function MarketOverviewTV({ theme='dark', height=400 }){
  ...
  return <TVWrap title="Market Overview" height={height} src="https://s.tradingview.com/external-embedding/embed-widget-market-overview.js" config={{
...
export function ScreenerTV({ theme='dark', height=420 }){
  const ct = theme==='light'?'light':'dark'
  return <TVWrap title="Screener" height={height} src="https://s.tradingview.com/external-embedding/embed-widget-screener.js" config={{
...
export function EconomicCalendar({ theme='dark', height=400 }){
  const ct = theme==='light'?'light':'dark'
  return <TVWrap title="Economic Calendar" height={height} src="https://s.tradingview.com/external-embedding/embed-widget-events.js" config={{
